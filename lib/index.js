...
let configfile = ".ftpconfig2"; // name of configfile
let panel = null;               // lmao
let modPanel = null;            // lmao
/*
  CHECK IF WIN
*/
...
client.on('data', function(data) {
  ...
  */
    ...
    panel.addText(jsondata.content);
    modPanel.show();
  }
  /*
    MESSAGE
  ...
  */
    ...
    setTimeout(function () {this.modalPanel.hide();},1000);
  }
  /*
    KILL
  */
    ...
    setTimeout(function () {this.modalPanel.hide();},5000);
  }
  /*
    RELOAD
  */
...
export default {
  ...
  activate(state) {
    ...
    this.rcview = new rcview(state.rcviewState);
    panel = this.rcview;
    this.modalPanel = atom.workspace.addModalPanel({
      item: this.rcview.getElement(),
      visible: false
    });
    modPanel = this.modalPanel;
  ...
  serialize() {
    return {
      rcviewState: this.rcview.serialize()
    };
  },
  ...
  */
  message() {
    ...
    var words = atom.clipboard.read().split(' . s');
