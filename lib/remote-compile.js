...
export default {
  ...
  changeproject() {
    //C:\Users\david\OneDrive\Desktop\ECER_SECOND_BOT\Default User\basic_test\src
    console.log('RemoteCompile was toggled!');
    if(connected){
        ...
        var projname = ""
        atom.notifications.addInfo(path.dirname(atom.workspace.getActiveTextEditor().getPath()));
        var pathy = path.dirname(atom.workspace.getActiveTextEditor().getPath());
        ...
        atom.notifications.addInfo(projname);
